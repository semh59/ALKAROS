...
namespace ALKAROS.Tables.CurrentPointers.Tests.Fixtures;

/// <summary>
/// Sets up an isolated test PostgreSQL database applying all prerequisite migrations up to 025-table-reservations.
/// </summary>
public sealed class TablePointerTestDatabase : PgTestDatabase
{
    public TablePointerTestDatabase()
        : base("alkaros_tbl005_")
    {
    }

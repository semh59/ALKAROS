...
- `CODE-014` bulgu zincirini dependency tasklerinin committed candidate'ı üzerinde yeniden üretmek.
...
- `evidence/V1-CAT-003/**` altında raw reproduction transcript'i, hash'ler ve terminal verdict.
...
- `python -B tools/plan-audit/plan_audit_tool.py validate` exit code `0` verir; repository write-set yalnız `evidence/V1-CAT-003/**` ve task metadata'sıdır.

# V0-REV-009 - Revalidate V0-DOM-002 decision evidence
...
Mevcut `docs/domain/bill-order-cardinality.md` Markdown kararındaki eksik kanıtı additive ve
tek-sorumluluklu bir supplement ile yeniden doğrulamak; eski artifact veya
`V0-DOM-002` görev gövdesini değiştirmemek.

## Owned surface

- `docs/decision-revalidation/V0-REV-009-v0-dom-002-decision-supplement.md`
- `evidence/V0-REV-009/**`

## In scope

- Tek Bill-Order cardinality sonucu, split örnekleri ve named domain approver kanıtı.
...
- `docs/domain/bill-order-cardinality.md`, `V0-DOM-002` görev Markdown'ı, PDF kaynak dosyası,
...
- `docs/decision-revalidation/V0-REV-009-v0-dom-002-decision-supplement.md` yolunda tek additive decision supplement.
...
- `docs/domain/bill-order-cardinality.md` ve `V0-DOM-002` dosyalarının before/after hash'i aynıdır.
- Supplement dışında yeni decision record sayısı `0` olur.
- `python -B tools/plan-audit/plan_audit_tool.py validate` exit code `0`
  verir; kanıtlar yalnız `evidence/V0-REV-009/**` altındadır.

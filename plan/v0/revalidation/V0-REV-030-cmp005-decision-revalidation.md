# V0-REV-030 - Revalidate V0-CMP-005 decision evidence
...
Mevcut `docs/compliance/accessibility-target.md` Markdown kararındaki eksik kanıtı additive ve
tek-sorumluluklu bir supplement ile yeniden doğrulamak; eski artifact veya
`V0-CMP-005` görev gövdesini değiştirmemek.

## Owned surface

- `docs/decision-revalidation/V0-REV-030-v0-cmp-005-decision-supplement.md`
- `evidence/V0-REV-030/**`

## In scope

- Accessibility target/exception matrix için named conformance approver kanıtı.
...
- `docs/compliance/accessibility-target.md`, `V0-CMP-005` görev Markdown'ı, PDF kaynak dosyası,
...
- `docs/decision-revalidation/V0-REV-030-v0-cmp-005-decision-supplement.md` yolunda tek additive decision supplement.
...
- `docs/compliance/accessibility-target.md` ve `V0-CMP-005` dosyalarının before/after hash'i aynıdır.
- Supplement dışında yeni decision record sayısı `0` olur.
- `python -B tools/plan-audit/plan_audit_tool.py validate` exit code `0`
  verir; kanıtlar yalnız `evidence/V0-REV-030/**` altındadır.

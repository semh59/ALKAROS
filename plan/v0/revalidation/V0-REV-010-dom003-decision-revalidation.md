# V0-REV-010 - Revalidate V0-DOM-003 decision evidence
...
Mevcut `docs/domain/refund-ledger.md` Markdown kararındaki eksik kanıtı additive ve
tek-sorumluluklu bir supplement ile yeniden doğrulamak; eski artifact veya
`V0-DOM-003` görev gövdesini değiştirmemek.

## Owned surface

- `docs/decision-revalidation/V0-REV-010-v0-dom-003-decision-supplement.md`
- `evidence/V0-REV-010/**`

## In scope

- Partial-refund ledger modeli, over/double-refund sonucu ve named finance/domain approver kanıtı.
...
- `docs/domain/refund-ledger.md`, `V0-DOM-003` görev Markdown'ı, PDF kaynak dosyası,
...
- `docs/decision-revalidation/V0-REV-010-v0-dom-003-decision-supplement.md` yolunda tek additive decision supplement.
...
- `docs/domain/refund-ledger.md` ve `V0-DOM-003` dosyalarının before/after hash'i aynıdır.
- Supplement dışında yeni decision record sayısı `0` olur.
- `python -B tools/plan-audit/plan_audit_tool.py validate` exit code `0`
  verir; kanıtlar yalnız `evidence/V0-REV-010/**` altındadır.

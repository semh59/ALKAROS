# V0-REV-012 - Revalidate V0-DOM-005 decision evidence
...
Mevcut `docs/domain/table-reservation-policy.md` Markdown kararındaki eksik kanıtı additive ve
tek-sorumluluklu bir supplement ile yeniden doğrulamak; eski artifact veya
`V0-DOM-005` görev gövdesini değiştirmemek.

## Owned surface

- `docs/decision-revalidation/V0-REV-012-v0-dom-005-decision-supplement.md`
- `evidence/V0-REV-012/**`

## In scope

- Reservation ownership/expiry karar provenance'i ve named operations/domain approver kanıtı.
...
- `docs/domain/table-reservation-policy.md`, `V0-DOM-005` görev Markdown'ı, PDF kaynak dosyası,
...
- `docs/decision-revalidation/V0-REV-012-v0-dom-005-decision-supplement.md` yolunda tek additive decision supplement.
...
- `docs/domain/table-reservation-policy.md` ve `V0-DOM-005` dosyalarının before/after hash'i aynıdır.
- Supplement dışında yeni decision record sayısı `0` olur.
- `python -B tools/plan-audit/plan_audit_tool.py validate` exit code `0`
  verir; kanıtlar yalnız `evidence/V0-REV-012/**` altındadır.

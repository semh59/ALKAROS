# V0-REV-004 - Revalidate V0-DAT-004 decision evidence
...
Mevcut `docs/data/projection-ownership.md` Markdown kararındaki eksik kanıtı additive ve
tek-sorumluluklu bir supplement ile yeniden doğrulamak; eski artifact veya
`V0-DAT-004` görev gövdesini değiştirmemek.

## Owned surface

- `docs/decision-revalidation/V0-REV-004-v0-dat-004-decision-supplement.md`
- `evidence/V0-REV-004/**`

## In scope

- Projection source/writer/rebuild ownership provenance'i ve named approver kanıtı.
...
- `docs/data/projection-ownership.md`, `V0-DAT-004` görev Markdown'ı, PDF kaynak dosyası,
...
- `docs/decision-revalidation/V0-REV-004-v0-dat-004-decision-supplement.md` yolunda tek additive decision supplement.
...
- `docs/data/projection-ownership.md` ve `V0-DAT-004` dosyalarının before/after hash'i aynıdır.
- Supplement dışında yeni decision record sayısı `0` olur.
- `python -B tools/plan-audit/plan_audit_tool.py validate` exit code `0`
  verir; kanıtlar yalnız `evidence/V0-REV-004/**` altındadır.

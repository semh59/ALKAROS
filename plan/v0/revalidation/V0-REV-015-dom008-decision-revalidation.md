# V0-REV-015 - Revalidate V0-DOM-008 decision evidence
...
Mevcut `docs/domain/reporting-metrics.md` Markdown kararındaki eksik kanıtı additive ve
tek-sorumluluklu bir supplement ile yeniden doğrulamak; eski artifact veya
`V0-DOM-008` görev gövdesini değiştirmemek.

## Owned surface

- `docs/decision-revalidation/V0-REV-015-v0-dom-008-decision-supplement.md`
- `evidence/V0-REV-015/**`

## In scope

- Reporting metric tanımı/provenance'i ve named reporting/business approver kanıtı.
...
- `docs/domain/reporting-metrics.md`, `V0-DOM-008` görev Markdown'ı, PDF kaynak dosyası,
...
- `docs/decision-revalidation/V0-REV-015-v0-dom-008-decision-supplement.md` yolunda tek additive decision supplement.
...
- `docs/domain/reporting-metrics.md` ve `V0-DOM-008` dosyalarının before/after hash'i aynıdır.
- Supplement dışında yeni decision record sayısı `0` olur.
- `python -B tools/plan-audit/plan_audit_tool.py validate` exit code `0`
  verir; kanıtlar yalnız `evidence/V0-REV-015/**` altındadır.

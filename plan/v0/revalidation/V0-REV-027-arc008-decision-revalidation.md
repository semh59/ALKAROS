# V0-REV-027 - Revalidate V0-ARC-008 decision evidence
...
Mevcut `docs/architecture/release-evidence-contract.md` Markdown kararındaki eksik kanıtı additive ve
tek-sorumluluklu bir supplement ile yeniden doğrulamak; eski artifact veya
`V0-ARC-008` görev gövdesini değiştirmemek.

## Owned surface

- `docs/decision-revalidation/V0-REV-027-v0-arc-008-decision-supplement.md`
- `evidence/V0-REV-027/**`

## In scope

- Release evidence level/schema kararı ve named release/security approver kanıtı.
...
- `docs/architecture/release-evidence-contract.md`, `V0-ARC-008` görev Markdown'ı, PDF kaynak dosyası,
...
- `docs/decision-revalidation/V0-REV-027-v0-arc-008-decision-supplement.md` yolunda tek additive decision supplement.
...
- `docs/architecture/release-evidence-contract.md` ve `V0-ARC-008` dosyalarının before/after hash'i aynıdır.
- Supplement dışında yeni decision record sayısı `0` olur.
- `python -B tools/plan-audit/plan_audit_tool.py validate` exit code `0`
  verir; kanıtlar yalnız `evidence/V0-REV-027/**` altındadır.

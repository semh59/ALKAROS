# V0-REV-013 - Revalidate V0-DOM-006 decision evidence
...
Mevcut `docs/domain/void-complimentary-discount-policy.md` Markdown kararındaki eksik kanıtı additive ve
tek-sorumluluklu bir supplement ile yeniden doğrulamak; eski artifact veya
`V0-DOM-006` görev gövdesini değiştirmemek.

## Owned surface

- `docs/decision-revalidation/V0-REV-013-v0-dom-006-decision-supplement.md`
- `evidence/V0-REV-013/**`

## In scope

- Void/complimentary/discount threshold kaynağı ve named business approver kanıtı.
...
- `docs/domain/void-complimentary-discount-policy.md`, `V0-DOM-006` görev Markdown'ı, PDF kaynak dosyası,
...
- `docs/decision-revalidation/V0-REV-013-v0-dom-006-decision-supplement.md` yolunda tek additive decision supplement.
...
- `docs/domain/void-complimentary-discount-policy.md` ve `V0-DOM-006` dosyalarının before/after hash'i aynıdır.
- Supplement dışında yeni decision record sayısı `0` olur.
- `python -B tools/plan-audit/plan_audit_tool.py validate` exit code `0`
  verir; kanıtlar yalnız `evidence/V0-REV-013/**` altındadır.

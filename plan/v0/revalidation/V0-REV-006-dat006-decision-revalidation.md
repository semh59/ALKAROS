# V0-REV-006 - Revalidate V0-DAT-006 decision evidence
...
Mevcut `docs/data/migration-rehearsal-profile.md` Markdown kararındaki eksik kanıtı additive ve
tek-sorumluluklu bir supplement ile yeniden doğrulamak; eski artifact veya
`V0-DAT-006` görev gövdesini değiştirmemek.

## Owned surface

- `docs/decision-revalidation/V0-REV-006-v0-dat-006-decision-supplement.md`
- `evidence/V0-REV-006/**`

## In scope

- Migration rehearsal dataset/control-total kararı için named migration/data approver kanıtı.
...
- `docs/data/migration-rehearsal-profile.md`, `V0-DAT-006` görev Markdown'ı, PDF kaynak dosyası,
...
- `docs/decision-revalidation/V0-REV-006-v0-dat-006-decision-supplement.md` yolunda tek additive decision supplement.
...
- `docs/data/migration-rehearsal-profile.md` ve `V0-DAT-006` dosyalarının before/after hash'i aynıdır.
- Supplement dışında yeni decision record sayısı `0` olur.
- `python -B tools/plan-audit/plan_audit_tool.py validate` exit code `0`
  verir; kanıtlar yalnız `evidence/V0-REV-006/**` altındadır.

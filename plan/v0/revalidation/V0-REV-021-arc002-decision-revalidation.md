# V0-REV-021 - Revalidate V0-ARC-002 decision evidence
...
Mevcut `docs/architecture/local-first-sync-contract.md` Markdown kararındaki eksik kanıtı additive ve
tek-sorumluluklu bir supplement ile yeniden doğrulamak; eski artifact veya
`V0-ARC-002` görev gövdesini değiştirmemek.

## Owned surface

- `docs/decision-revalidation/V0-REV-021-v0-arc-002-decision-supplement.md`
- `evidence/V0-REV-021/**`

## In scope

- Local-first conflict/reconnect model provenance'i ve named architecture/product approver kanıtı.
...
- `docs/architecture/local-first-sync-contract.md`, `V0-ARC-002` görev Markdown'ı, PDF kaynak dosyası,
...
- `docs/decision-revalidation/V0-REV-021-v0-arc-002-decision-supplement.md` yolunda tek additive decision supplement.
...
- `docs/architecture/local-first-sync-contract.md` ve `V0-ARC-002` dosyalarının before/after hash'i aynıdır.
- Supplement dışında yeni decision record sayısı `0` olur.
- `python -B tools/plan-audit/plan_audit_tool.py validate` exit code `0`
  verir; kanıtlar yalnız `evidence/V0-REV-021/**` altındadır.

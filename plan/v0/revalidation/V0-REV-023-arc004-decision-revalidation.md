# V0-REV-023 - Revalidate V0-ARC-004 decision evidence
...
Mevcut `docs/architecture/api-contract-standard.md` Markdown kararındaki eksik kanıtı additive ve
tek-sorumluluklu bir supplement ile yeniden doğrulamak; eski artifact veya
`V0-ARC-004` görev gövdesini değiştirmemek.

## Owned surface

- `docs/decision-revalidation/V0-REV-023-v0-arc-004-decision-supplement.md`
- `evidence/V0-REV-023/**`

## In scope

- API/event standardının technology/policy source'u ve named architecture approver kanıtı.
...
- `docs/architecture/api-contract-standard.md`, `V0-ARC-004` görev Markdown'ı, PDF kaynak dosyası,
...
- `docs/decision-revalidation/V0-REV-023-v0-arc-004-decision-supplement.md` yolunda tek additive decision supplement.
...
- `docs/architecture/api-contract-standard.md` ve `V0-ARC-004` dosyalarının before/after hash'i aynıdır.
- Supplement dışında yeni decision record sayısı `0` olur.
- `python -B tools/plan-audit/plan_audit_tool.py validate` exit code `0`
  verir; kanıtlar yalnız `evidence/V0-REV-023/**` altındadır.

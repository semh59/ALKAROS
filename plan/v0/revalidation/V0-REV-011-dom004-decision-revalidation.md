# V0-REV-011 - Revalidate V0-DOM-004 decision evidence
...
Mevcut `docs/domain/payment-allocation-integrity.md` Markdown kararındaki eksik kanıtı additive ve
tek-sorumluluklu bir supplement ile yeniden doğrulamak; eski artifact veya
`V0-DOM-004` görev gövdesini değiştirmemek.

## Owned surface

- `docs/decision-revalidation/V0-REV-011-v0-dom-004-decision-supplement.md`
- `evidence/V0-REV-011/**`

## In scope

- Payment reversal representation ve allocation invariant'ları için named payment/domain approver kanıtı.
...
- `docs/domain/payment-allocation-integrity.md`, `V0-DOM-004` görev Markdown'ı, PDF kaynak dosyası,
...
- `docs/decision-revalidation/V0-REV-011-v0-dom-004-decision-supplement.md` yolunda tek additive decision supplement.
...
- `docs/domain/payment-allocation-integrity.md` ve `V0-DOM-004` dosyalarının before/after hash'i aynıdır.
- Supplement dışında yeni decision record sayısı `0` olur.
- `python -B tools/plan-audit/plan_audit_tool.py validate` exit code `0`
  verir; kanıtlar yalnız `evidence/V0-REV-011/**` altındadır.

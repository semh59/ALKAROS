# V0-REV-016 - Revalidate V0-DOM-009 decision evidence
...
Mevcut `docs/domain/receipt-variance-policy.md` Markdown kararındaki eksik kanıtı additive ve
tek-sorumluluklu bir supplement ile yeniden doğrulamak; eski artifact veya
`V0-DOM-009` görev gövdesini değiştirmemek.

## Owned surface

- `docs/decision-revalidation/V0-REV-016-v0-dom-009-decision-supplement.md`
- `evidence/V0-REV-016/**`

## In scope

- Receipt variance sonuç/yetki matrisi için named business approver kanıtı.
...
- `docs/domain/receipt-variance-policy.md`, `V0-DOM-009` görev Markdown'ı, PDF kaynak dosyası,
...
- `docs/decision-revalidation/V0-REV-016-v0-dom-009-decision-supplement.md` yolunda tek additive decision supplement.
...
- `docs/domain/receipt-variance-policy.md` ve `V0-DOM-009` dosyalarının before/after hash'i aynıdır.
- Supplement dışında yeni decision record sayısı `0` olur.
- `python -B tools/plan-audit/plan_audit_tool.py validate` exit code `0`
  verir; kanıtlar yalnız `evidence/V0-REV-016/**` altındadır.

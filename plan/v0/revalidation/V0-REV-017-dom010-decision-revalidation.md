# V0-REV-017 - Revalidate V0-DOM-010 decision evidence
...
Mevcut `docs/domain/inventory-cost-basis.md` Markdown kararındaki eksik kanıtı additive ve
tek-sorumluluklu bir supplement ile yeniden doğrulamak; eski artifact veya
`V0-DOM-010` görev gövdesini değiştirmemek.

## Owned surface

- `docs/decision-revalidation/V0-REV-017-v0-dom-010-decision-supplement.md`
- `evidence/V0-REV-017/**`

## In scope

- Inventory cost basis/formula kararı için named finance/inventory approver kanıtı.
...
- `docs/domain/inventory-cost-basis.md`, `V0-DOM-010` görev Markdown'ı, PDF kaynak dosyası,
...
- `docs/decision-revalidation/V0-REV-017-v0-dom-010-decision-supplement.md` yolunda tek additive decision supplement.
...
- `docs/domain/inventory-cost-basis.md` ve `V0-DOM-010` dosyalarının before/after hash'i aynıdır.
- Supplement dışında yeni decision record sayısı `0` olur.
- `python -B tools/plan-audit/plan_audit_tool.py validate` exit code `0`
  verir; kanıtlar yalnız `evidence/V0-REV-017/**` altındadır.

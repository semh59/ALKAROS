# V0-REV-008 - Revalidate V0-DOM-001 decision evidence
...
Mevcut `docs/domain/lifecycle-transition-contracts.md` Markdown kararındaki eksik kanıtı additive ve
tek-sorumluluklu bir supplement ile yeniden doğrulamak; eski artifact veya
`V0-DOM-001` görev gövdesini değiştirmemek.

## Owned surface

- `docs/decision-revalidation/V0-REV-008-v0-dom-001-decision-supplement.md`
- `evidence/V0-REV-008/**`

## In scope

- Lifecycle state uyumu, timeout/unknown state ve provider boundary için named domain approver kanıtı.
...
- `docs/domain/lifecycle-transition-contracts.md`, `V0-DOM-001` görev Markdown'ı, PDF kaynak dosyası,
...
- `docs/decision-revalidation/V0-REV-008-v0-dom-001-decision-supplement.md` yolunda tek additive decision supplement.
...
- `docs/domain/lifecycle-transition-contracts.md` ve `V0-DOM-001` dosyalarının before/after hash'i aynıdır.
- Supplement dışında yeni decision record sayısı `0` olur.
- `python -B tools/plan-audit/plan_audit_tool.py validate` exit code `0`
  verir; kanıtlar yalnız `evidence/V0-REV-008/**` altındadır.

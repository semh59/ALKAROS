# V0-REV-014 - Revalidate V0-DOM-007 decision evidence
...
Mevcut `docs/domain/customer-credit-invoice-semantics.md` Markdown kararındaki eksik kanıtı additive ve
tek-sorumluluklu bir supplement ile yeniden doğrulamak; eski artifact veya
`V0-DOM-007` görev gövdesini değiştirmemek.

## Owned surface

- `docs/decision-revalidation/V0-REV-014-v0-dom-007-decision-supplement.md`
- `evidence/V0-REV-014/**`

## In scope

- Customer credit/invoice reclassification provenance'i ve named finance/domain approver kanıtı.
...
- `docs/domain/customer-credit-invoice-semantics.md`, `V0-DOM-007` görev Markdown'ı, PDF kaynak dosyası,
...
- `docs/decision-revalidation/V0-REV-014-v0-dom-007-decision-supplement.md` yolunda tek additive decision supplement.
...
- `docs/domain/customer-credit-invoice-semantics.md` ve `V0-DOM-007` dosyalarının before/after hash'i aynıdır.
- Supplement dışında yeni decision record sayısı `0` olur.
- `python -B tools/plan-audit/plan_audit_tool.py validate` exit code `0`
  verir; kanıtlar yalnız `evidence/V0-REV-014/**` altındadır.

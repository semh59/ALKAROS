# V0-REV-020 - Revalidate V0-ARC-001 decision evidence
...
Mevcut `docs/architecture/module-dependency-rules.md` Markdown kararındaki eksik kanıtı additive ve
tek-sorumluluklu bir supplement ile yeniden doğrulamak; eski artifact veya
`V0-ARC-001` görev gövdesini değiştirmemek.

## Owned surface

- `docs/decision-revalidation/V0-REV-020-v0-arc-001-decision-supplement.md`
- `evidence/V0-REV-020/**`

## In scope

- Tek cross-module iletişim modeli, cycle-free graph ve named architecture approver kanıtı.
...
- `docs/architecture/module-dependency-rules.md`, `V0-ARC-001` görev Markdown'ı, PDF kaynak dosyası,
...
- `docs/decision-revalidation/V0-REV-020-v0-arc-001-decision-supplement.md` yolunda tek additive decision supplement.
...
- `docs/architecture/module-dependency-rules.md` ve `V0-ARC-001` dosyalarının before/after hash'i aynıdır.
- Supplement dışında yeni decision record sayısı `0` olur.
- `python -B tools/plan-audit/plan_audit_tool.py validate` exit code `0`
  verir; kanıtlar yalnız `evidence/V0-REV-020/**` altındadır.

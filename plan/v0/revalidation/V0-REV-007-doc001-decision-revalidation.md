# V0-REV-007 - Revalidate V0-DOC-001 decision evidence
...
Mevcut `docs/specification/restaurant-pos-master.md` Markdown kararındaki eksik kanıtı additive ve
tek-sorumluluklu bir supplement ile yeniden doğrulamak; eski artifact veya
`V0-DOC-001` görev gövdesini değiştirmemek.

## Owned surface

- `docs/decision-revalidation/V0-REV-007-v0-doc-001-decision-supplement.md`
- `evidence/V0-REV-007/**`

## In scope

- Source-bound Markdown baseline dependency closure, exact source hash ve named specification owner kanıtı.
...
- `docs/specification/restaurant-pos-master.md`, `V0-DOC-001` görev Markdown'ı, PDF kaynak dosyası,
...
- `docs/decision-revalidation/V0-REV-007-v0-doc-001-decision-supplement.md` yolunda tek additive decision supplement.
...
- `docs/specification/restaurant-pos-master.md` ve `V0-DOC-001` dosyalarının before/after hash'i aynıdır.
- Supplement dışında yeni decision record sayısı `0` olur.
- `python -B tools/plan-audit/plan_audit_tool.py validate` exit code `0`
  verir; kanıtlar yalnız `evidence/V0-REV-007/**` altındadır.
